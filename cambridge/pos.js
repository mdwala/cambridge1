...
erpnext.pos.PointOfSale = erpnext.taxes_and_totals.extend({
	...
	update_customer_data: function (doc) {
		...
		this.frm.doc.registration = doc.registration;
		this.frm.doc.telephone_no = doc.telephone_no;
		this.frm.doc.pos_user = this.pos_profile_data['user_name'];
		this.pos_bill.show();
